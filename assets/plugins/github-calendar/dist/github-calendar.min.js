    ...
    return function o(s, u, i) {
            ...
            t.exports = function(b, e, m) {
                ...
                m.getCalendar = m.getCalendar || function(e) {
                    ...
                    return m.proxy(e).then(function(e) {
                        return m.cache && (localStorage.setItem(r.content, e),
                        localStorage.setItem(r.expire_at, Date.now() + m.cache)),
                        e
                    })
                }
                ;
                return function g() {
                    return m.getCalendar(e).then(function(e) {
                        ...
                        p.querySelector("include-fragment") ? setTimeout(g, 500) : (!0 === m.responsive && (n = (r = p.querySelector("svg.js-calendar-graph-svg")).getAttribute("width"),
                        a = r.getAttribute("height"),
                        r.removeAttribute("height"),
                        r.setAttribute("width", "100%"),
                        r.setAttribute("viewBox", "0 0 " + n + " " + a)),
                        !1 !== m.global_stats && (s = (o = h(y("svg", p).outerHTML)).current_streak ? M(o.current_streak_range[0], _) + " &ndash; " + M(o.current_streak_range[1], _) : o.last_contributed ? "Last contributed in " + M(o.last_contributed, _) + "." : "Rock - Hard Place",
                        u = o.longest_streak ? M(o.longest_streak_range[0], _) + " &ndash; " + M(o.longest_streak_range[1], _) : o.last_contributed ? "Last contributed in " + M(o.last_contributed, _) + "." : "Rock - Hard Place",
                        i = y("<div>", {
                        ...
                        d.querySelectorAll("rect.day").forEach(function(e) {
                            e.addEventListener("mouseenter", function(e) {
                                ...
                                f.innerHTML = "<strong>" + t + "</strong> on " + n,
                                ...
                                var a = e.target.getBoundingClientRect()
                                  ...
                                  console.log(a, window.pageXOffset)
                                f.style.top = s + "px",
                                f.style.left = o + "px"
                            }),
        ...
        4: [function(e, t, r) {
            var n = e("iterate-object")
              , a = e("sliced");
            function o(r, e) {
                return "string" == typeof r ? "<" === r.charAt(0) ? (r = document.createElement(r.slice(1, -1)),
                n(e || {}, function(e, t) {
                    switch (t) {
                    case "text":
        ...
        8: [function(e, t, r) {
            ...
            t.exports = function(e) {
                function o() {
                    s.current_streak > s.longest_streak && (s.longest_streak = s.current_streak,
                ...
                return e.split("\n").slice(2).map(function(e) {
                    ...
                    var t, r = e.match(/fill="(#[a-z0-9]+)"/), n = e.match(/data-date="([0-9\-]+)"/), a = e.match(/data-count="([0-9]+)"/), r = r && r[1], n = n && n[1], a = a && +a[1];
                    r && (t = {
                        fill: r,
                        date: new Date(n),
                        count: a,
                    ...
                    t.count ? (++s.current_streak,
                    s.last_year += t.count,
                    s.last_contributed = t.date,
                    s.current_streak_range[1] = t.date) : (o(),
                    s.current_streak = 0),
                    u.push(t),
                    s.days.push(t))
                }),
            ...
            var o = e("regex-escape")
              , s = (n(u, [{
                ...
                value: function(e, t) {
                    ...
                    t = t || [];
                    do {
                        var n, a = e.match(this.re), o = a && a[1], s = o || e.charAt(0);
                        o ? ("function" == typeof (n = this.obj[o]) && (n = n.apply(this, t)),
                        r += n) : r += s,
